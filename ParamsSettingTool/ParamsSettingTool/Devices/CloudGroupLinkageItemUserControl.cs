...
{
    public partial class CloudGroupLinkageItemUserControl : GeneralUserControl
    {
        ...
        public int ItemId
        {
            ...
            set
            {
                ...
                {
                    f_ItemId = value;
                    this.liDevIp.Text = string.Format("{0}号云群控器IP地址", f_ItemId);
                }
            }
        }
        ...
        public CloudGroupLinkageItemUserControl()
        {
            InitializeComponent();
            lblConStatues.Text = " ";
        }
