...
namespace ITL.Framework
{
	public class FolderBrowserDialogEx
	{
        ...
        public string  LblFolederText { get; set; }
		...
		private void _adjustUi(IntPtr hDlg, IntPtr lpData)
		{
			...
			if (hCancel != IntPtr.Zero)
			{
                ...
                Win32.SetWindowText(hCancel, CancelButtonCaption);
			...
			if (hOK != IntPtr.Zero)
			{
                ...
                Win32.SetWindowText(hOK, OKButtonCaption);
			...
			if (hEdit != IntPtr.Zero)
			{
				...
				{
                    string labelText = string.Format("{0}:", LblFolederText);
